  ...
  return (
    ...
    <div className="d-flex justify-content-center">
      ...
      <div className="container">
        <table className="table text-center ">
          <thead className="text-success fs-4">
            <tr>
              <th scope="col" className="px-4">Sr no.</th>
              <th scope="col" className="px-4">Pizza Name</th>
              <th scope="col" className="px-4">Quantity</th>
              <th scope="col" className="px-4">Variant</th>
              <th scope="col" className="px-4">Amount</th>
              <th scope="col" className="px-4">Update</th>
              <th scope="col" className="px-4">Delete</th>
            </tr>
          </thead>
          <tbody>
                ...
                <td>
                  <div className="d-flex justify-content-center ">
                      <button
                        ...
                        onClick={() => {
                          dispatch(
                            addToCart(pizza, pizza.quantity - 1, pizza.variant)
                          );
                        }}
                      >
                        -
      ...
      <div className="card shadow p-3 m-3 w-25 h-25">
        ...
        <Link to={'/'} className="btn btn-lg">Checkout<FontAwesomeIcon className='p-2' icon={faArrowRight} /></Link>
        </div>
      </div>
    </div>
    </>
